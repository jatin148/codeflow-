            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
                    {plans.map((plan, index) => (
                        <div
                            key={index}
                            className={`relative bg-slate-900/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-hidden group flex flex-col h-full
                                ${plan.mostPopular
                                    ? "border-blue-500/20 lg:scale-105"
                        ...
                        >
                            ...
                            {/* CTA Button */}
                            <button
                                className={`w-full px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 mt-auto hover:scale-105 cursor-pointer
                                    ${plan.mostPopular
