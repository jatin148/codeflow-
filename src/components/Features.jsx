...
const features = [
    ...
    description: 
    "Intelligent code suggestion powered by advanced AI that learns from your patterns. Get real-time assistance with syntax, logic, and best practices.",
    codeSnippet: `fuction handSubmit() {
                ...
                <div key={key} className={`flex flex-col lg:flex-row items-center gap-8 sm:gap-12 ${feature.imagePosition === "right" ? "lg:flex-row-reverse":"" } `}>
                    ...
                    <div className="flex-1 w-full">
                        <div className="relative group">
                            <div className="absolute insert-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20
